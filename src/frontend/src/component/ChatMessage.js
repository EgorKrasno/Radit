        ...
        <>
            {message.recipient !== user ?
                <div className="flex mr-3 mt-1.5 mb-1.5 self-end">
                    <div
                        className="border-transparent text-sm ring-1 ring-gray-200 ring-opacity-75 rounded-2xl ml-20 mr-1.5 mb-0.5 mt-1 px-3 py-1.5 shadow-md">
                        <p className="rounded-2xl text-gray-900">{message['message']}</p>
                    </div>
                    <div
                ...
                <div className="flex ml-3 mt-1.5 mb-1.5 self-start">
                    ...
                    <div
                        className="border-transparent ring-1 ring-gray-200 ring-opacity-75 rounded-2xl mr-20 ml-1.5 mb-0.5 mt-1 px-3 py-1.5 shadow-md">
                        <p className="rounded-2xl text-gray-900">{message['message']}</p>
                    </div>
                </div>
            }
