...
public class SecurityConstant {
    ...
    public static final String[] PUBLIC_URLS = {"/j/*", "/api/user/register", "/api/leaderboard/top", "/api/user/health", "/api/user/login", "/api/user/data/*", "/api/comments/*", "/", "/static/**", "/manifest.json", "/*.png", "/*.ico"};
}
