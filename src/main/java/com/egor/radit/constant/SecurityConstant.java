...
public class SecurityConstant {
    ...
    public static final String[] PUBLIC_URLS = {"/All", "/RareMemes", "/Programming", "/Beans", "/Random", "/api/user/register", "/api/leaderboard/top", "/api/user/login", "/api/user/data/*", "/api/posts/all", "/api/comments/*", "/", "/static/**", "/manifest.json", "/*.png", "/*.ico"};
}
