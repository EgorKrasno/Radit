...
public class SecurityConstant {
    ...
    public static final String[] PUBLIC_URLS = {"/All", "/RareMemes", "/Programming", "/Beans", "/Random", "/api/user/register", "api/user/health", "/api/user/login", "/api/posts/all", "/api/comments/*", "/", "/static/**", "/manifest.json", "/*.png", "/*.ico"};
}
